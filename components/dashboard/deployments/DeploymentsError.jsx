...
export default function DeploymentsError({ refetch }) {
  return (
    <Reveal>
      <div className="mx-auto flex max-w-lg flex-col items-center rounded-feature border border-red-500/20 bg-red-500/[0.04] p-12 text-center">
        ...
        <h3 className="mt-5 text-xl font-medium text-vellum">Couldn't load deployments</h3>
        <p className="mt-2 max-w-md text-[15px] leading-relaxed text-ash">
          There was a problem reaching the deployments service. Check your connection or try again.
        </p>
