...
export default function Home() {
  return (
    <div className="flex flex-col flex-1 bg-black font-sans text-white overflow-hidden">
      <section className="relative px-4 sm:px-6 lg:px-8 pt-20 pb-28 md:pt-32 md:pb-40 max-w-7xl mx-auto text-center flex flex-col items-center w-full">
        ...
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-zinc-800 bg-zinc-900/80 backdrop-blur-sm mb-8 animate-in fade-in slide-in-from-bottom-3 duration-500">
          ...
          <span className="text-xs font-mono font-medium text-zinc-300">Nexel AI SDK 4.0 Available</span>
        </div>
      ...
      <section id="features" className="px-4 sm:px-6 lg:px-8 py-24 max-w-7xl mx-auto border-t border-zinc-900 w-full relative">
        <div className="absolute top-0 left-1/3 -translate-x-1/2 -translate-y-1/2 w-[450px] h-[250px] bg-gradient-to-br from-blue-600/5 via-emerald-500/5 to-transparent blur-[100px] pointer-events-none rounded-full" />
      ...
      <section className="px-4 sm:px-6 lg:px-8 py-20 my-12 max-w-5xl mx-auto w-full relative">
